...
# Load the DataFrame
recipe_data = pd.read_csv("recipe_data_test.csv")
...
all_ingredients = sorted(
    set(ingredient for sublist in recipe_data['test'] for ingredient in sublist)
)
...
if st.button("Search Recipes"):
    ...
    if selected_ingredients:
        filtered = filtered[filtered['test'].apply(lambda x: all(i in x for i in selected_ingredients))]
